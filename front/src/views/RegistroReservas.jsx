        ...
        <div className="registrocot">
            <div className="regwrapper fadeInDown container">
                <div className="user-details2 ">
                    <div className="input-resev formulario" hidden={validar? true:false}>
                    ...
                    <Row xs="2" className="info">
                            ...
                            <Row xs="2" className="info">
                                <Col><input type="text" className="fadeIn first" name="login" placeholder={nombre} disabled/></Col>
                                <Col><input type="text" className="fadeIn first" name="login" placeholder={apellido} disabled/></Col>
                            </Row>
                            <Row xs="2" className="info">
