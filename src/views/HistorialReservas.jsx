                                        ...
                                        renderizar.map((reserva,i)=>(
                                            <tr key={reserva._id}>
                                                ...
                                                <td className="acciones"> 
                                                    <button className="editar" data-toggle="modal" data-target="#actualizarReserva" onClick={()=>obtenerInfo(reserva._id)}><i class="fas fa-edit"></i></button>
                                                    <button className="eliminar" onClick={()=>eliminar(reserva._id)}><i class="far fa-trash-alt"></i></button>                                                    
                                                </td>                                            
                                            </tr>
                                        ))
                                    }
