...
export const Nosotros = () => {
    return (
        <div className="">
            ...
            <Image style={{"width": "100%", "paddingTop":"20px"}} src="https://www.clubcampestre.co/wp-content/uploads/2019/03/el-club-banner-club-campestre-1366x450_c.jpg" alt="El Club" title="El Club"/>
            </figure>
            <Row>
            <Col > 
            ...
            <div className="grid_91">
                ...
                <h3 style={{paddingBottom :"10px", paddingTop:"200px"}}>Visión</h3>
                ...
                <h3 style={{paddingBottom :"10px", paddingTop:"230px"}}>Nuestros Valores</h3>
